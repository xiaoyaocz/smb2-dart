...
MsException getStatus(int errorCode) {
  ...
  Map<String, dynamic> ntErr = ntStatus[hex] ??
      win32ErrorCodes[hex] ??
      {
  ...
  final err = MsException(
      code: ntErr['code'],
      message: ntErr['message'],
      value: errorCode,
      valueHex: hex);
  ...
  err.severity = MsStatusInfo(
      code: severityData['code'],
      message: severityData['message'],
      value: severity);
